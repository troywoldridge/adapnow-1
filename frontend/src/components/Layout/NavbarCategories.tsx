...
interface Category extends Sublink {
  sublinks: Sublink[];
}

// Helper Component: CategoryItem
const CategoryItem: React.FC<Category> = ({ label, sublinks }) => {
  ...
  return (
    ...
    >
      <button className="font-bold hover:underline">{label}</button>
      {isDropdownOpen && sublinks.length > 0 && (
        <div className="absolute left-0 top-full mt-2 bg-white text-black shadow-lg rounded-lg border border-gray-200">
          <ul className="py-2">
            {sublinks.map((link, index) => (
              <li key={index} className="px-4 py-2 hover:bg-gray-100 whitespace-nowrap">
...
const categories: Category[] = [
    ...
    },
    {
        ...
        { label: "Print Services", href: "/services/print" },
    ...
    },
    {
        ...
        { label: "Bookmarks", href: "/products/bookmarks" },
        { label: "Presentation Folders", href: "/products/presentation-folders" },
        { label: "Booklets", href: "/products/booklets" },
        { label: "Magnets", href: "/products/magnets" },
        { label: "Greeting Cards", href: "/products/greeting-cards" },
        { label: "Invitations / Announcements", href: "/products/invitations-announcements" },
        { label: "Numbered Tickets", href: "/products/numbered-tickets" },
        { label: "Wall Calendars", href: "/products/wall-calendars" },
        { label: "Variable Printing", href: "/products/variable-printing" },
        { label: "Posters", href: "/products/posters" },
        { label: "Door Hangers", href: "/products/door-hangers" },
        { label: "Digital Sheets", href: "/products/digital-sheets" },
        { label: "Folded Business Cards", href:"/products/folded-business-cards"},
        { label:"Tent Cards",href:"/products/tent-cards"},
        {label:"Plastics",href:"/products/plastics"},
        {label:"Tear Cards",href:"/products/tear-cards"},
        {label:"Clings",href:"/products/clings"},
        ],
    },
  {
    ...
    sublinks: [
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: "Ultra Smooth", href: "/business-cards/specialty/ultra-smooth-bc" },
        ],
      },
    ],
  },
  {
    ...
    sublinks: [
      ...
      },
      {
        ...
        sublinks: [
          ...
          },
          {
            ...
            href: "/print-products/lamination",
            sublinks: [
      ...
      },
      {
        ...
        sublinks: [
            { label: "14pt Matte Finish", href: "/print-products/presentation-folders/14pt-matte-pf" },
            { label: "14pt Standard UV", href: "/print-products/presentation-folders/14pt-standard-uv-pf" },
      ...
      },
      {
        ...
        sublinks: [
          {
            label: "8.5 x 11",
            href: "/print-products/b/8.5-x-11",
            sublinks: [
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: "149t UV", href: "/print-products/invitations/14pt-uv-ia" },
    ...
    sublinks: [
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: "8oz Polyster Mesh", href: "large-format/banners/8pz-mesh-banners" },
        ],
      },
      {
        ...
        sublinks: [
         ...
         },
         {
           ...
           sublinks: [
            { label: "13ox Matte Vinyl", href: "/large-format/x-frame/13ox matte-x-frame" },
           ]}
        ],
      },
      {
    ...
    sublinks: [
      ...
      },
      {
        ...
        sublinks: [
          ...
          { label: "Auro Lock Bottom (ALB)", href: "/labels-and-packaging/product-boxes/alb" },
    ...
    <div className="bg-blue-500 text-white">
      <nav className="flex justify-center space-x-8 py-2">
        ...
        {categories.map((category, index) => (
          <CategoryItem key={index} label={category.label} href={category.href} sublinks={category.sublinks} />
        ))}
      </nav>
    </div>
  );
